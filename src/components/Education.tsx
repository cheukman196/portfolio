  ...
  return (
    <>  
        <section className="flex flex-col text-white font-roboto font-[350] selection:bg-teal-300 selection:text-gray-800 group/edu">
            <div className="p-5 my-2 max-w-lg flex flex-col justify-center rounded-md hover:shadow-md hover:bg-gray-500/5 border-t-1 border-t-transparent hover:border-t-gray-500/20 transition delay-150 group-hover/edu:opacity-35 hover:!opacity-100 group/item">
